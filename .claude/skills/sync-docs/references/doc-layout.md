...
| `src/schema/clone-chain.ts`                             | `docs/schema-identity.md`                                                                                                                            | Which Zod operators clone, annotation vs constraint clones, what resolves through the chain (ids, document refs) and what stays instance-keyed (`overrideJSONSchema`, `extend` lineage), `z.compile()` guidance.                    |
